!function() {
    ...
    function b(o, e, s, c) {
        ...
        return e.forEach(function(e, n) {
            var t, a, i, r;
            "heading" === e.type && e.depth <= c ? (t = (a = (i = e.text,
            r = {},
            {
                str: i = (i = void 0 === i ? "" : i) && i.replace(/^('|")/, "").replace(/('|")$/, "").replace(/(?:^|\s):([\w-]+:?)=?([\w-%]+)?/g, function(e, n, t) {
                    return -1 === n.indexOf(":") ? (r[n] = t && t.replace(/&quot;/g, "") || !0,
                    "") : e
                }).trim(),
                config: r
            })).str,
        ...
        for (var i = 0; i < t.length; i++)
            !function(e) {
                ...
                d && (a.forEach(function(e) {
                    ...
                    a = c && "..." + c.substring(n, t).replace(a, function(e) {
    ...
    function r(a, i) {
        var t, r, n, e, o = "auto" === a.paths, s = o ? (t = i.router,
        r = [],
        ...
        r) : a.paths, c = "";
        s.length && o && a.pathNamespaces ? (n = s[0],
        Array.isArray(a.pathNamespaces) ? c = a.pathNamespaces.filter(function(e) {
            return n.slice(0, e.length) === e
        })[0] || c : a.pathNamespaces instanceof RegExp && ((d = n.match(a.pathNamespaces)) && (c = d[0])),
        e = -1 === s.indexOf(c + "/"),
        d = -1 === s.indexOf(c + "/README"),
        e && d && s.unshift(c + "/")) : -1 === s.indexOf("/") && -1 === s.indexOf("/README") && s.unshift("/");
        var d, l = ((d = a.namespace) ? m.EXPIRE_KEY + "/" + d : m.EXPIRE_KEY) + c, p = ((d = a.namespace) ? m.INDEX_KEY + "/" + d : m.INDEX_KEY) + c, c = localStorage.getItem(l) < Date.now();
        if (f = JSON.parse(localStorage.getItem(p)),
        c)
            f = {};
        else if (!o)
            return;
    ...
    function d(e) {
        ...
        if (!e)
            ...
            t.innerHTML = "",
            void (s.hideOtherSidebarContent && (i && i.classList.remove("hide"),
        ...
        s.hideOtherSidebarContent && (i && i.classList.add("hide"),
    ...
    function h(e, n) {
        ...
        function(e) {
            ...
            Docsify.dom.toggleClass(n, "search"),
            Docsify.dom.before(e, n)
        }(i),
    ...
    function x(e, n) {
        ...
        e = e.noData,
        o = n.route.path,
        c = "string" == typeof e ? e : e[Object.keys(e).filter(function(e) {
    ...
    $docsify.plugins = [].concat(function(e, n) {
        var t = Docsify.util
          , a = n.config.search || w;
        Array.isArray(a) ? w.paths = a : "object" == typeof a && (w.paths = Array.isArray(a.paths) ? a.paths : "auto",
